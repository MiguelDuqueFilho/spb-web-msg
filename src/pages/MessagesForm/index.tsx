        ...
        >
          ...
          >
            <InputString
              ...
              min={8}
              max={8}
              {...register(`DOC.BCMSG.IdentdEmissor` as const, {
                required: true,
              })}
              className={errors?.DOC?.BCMSG?.IdentdEmissor ? 'error' : ''}
              defaultValue=""
            />
            <InputString
              ...
              pattern={`[0-9]{0,${8}}`}
              maxLength={8}
              {...register(`DOC.BCMSG.IdentdDestinatario` as const, {
                required: true,
              })}
              className={errors?.DOC?.BCMSG?.IdentdDestinatario ? 'error' : ''}
              defaultValue=""
            />
            <Group
              name="Grupo_Seq"
            ...
            >
              <InputInteger
                ...
                pattern={`[0-9]{0,${8}}`}
                maxLength={8}
                {...register(`DOC.BCMSG.Grupo_Seq.NumSeq` as const, {
                  required: true,
                })}
                className={errors?.DOC?.BCMSG?.Grupo_Seq?.NumSeq ? 'error' : ''}
                defaultValue=""
              />
              <InputString
                type="text"
            ...
            <Choice>
              ...
              >
                <InputString
                  ...
                  max={8}
                  readOnly
                  {...register(`DOC.SISMSG.STR0000.CodMsg` as const, {
                    required: true,
                  })}
                  className={
                    errors?.DOC?.SISMSG?.STR0000?.CodMsg ? 'error' : ''
                  }
                ...
                >
                  <InputInteger
                    ...
                    className={
                      errors?.DOC?.SISMSG?.STR0000?.Grupo_BMC0004_OpInterbanc
                        ?.TaxCam
                        ? 'error'
                        : ''
                    }
                  ...
                  >
                    <InputString
                      ...
                      className={
                        errors?.DOC?.SISMSG?.STR0000?.Grupo_BMC0004_OpInterbanc
                          ?.Grupo_BMC0004_OpContrd?.NumCtrlBMC
                          ? 'error'
                          : ''
                      }
                    />
                ...
                <InputDate
                  ...
                  required
                  // value={inputXsDate}
                  {...register(`DOC.SISMSG.STR0000.DtMovto` as const, {
                    required: false,
                  })}
                  className={
                    errors?.DOC?.SISMSG?.STR0000?.DtMovto ? 'error' : ''
                  }
                />
              </Message>
              <Message name="STR0000R1" Mensagem="Mensagem de teste STR0000R1">
                <InputString
                  // "name": "CodMsg",
                  // "DescricaoTipo": "Código da mensagem do sistema associado ao evento.",
                  // "base": "xs:string",
                  ...
                  // value="STR0000R1"
                  readOnly
                  {...register(`DOC.SISMSG.STR0000R1.CodMsg` as const, {
                    required: true,
                  })}
                  className={
                    errors?.DOC?.SISMSG?.STR0000R1?.CodMsg ? 'error' : ''
                  }
                ...
                <InputDecimal
                  ...
                  {...register(`DOC.SISMSG.STR0000R1.valor` as const, {
                    required: true,
                  })}
                  className={
                    errors?.DOC?.SISMSG?.STR0000R1?.valor
                      ? 'CurrencyInput error'
                      : 'CurrencyInput'
                  }
                />
